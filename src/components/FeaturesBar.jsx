...
const FeaturesBar = () => {
  ...
  const moneyBackBadge = new URL('../assets/images/30-days.png', import.meta.url).href
              ...
              <div className="feature-item">
                <div className="feature-icon">
                  ...
                  {feature.iconType === 'svg-secure' && (
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#054C73" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
